var Oo=Object.defineProperty;var qi=Object.getOwnPropertySymbols;var _o=Object.prototype.hasOwnProperty,ko=Object.prototype.propertyIsEnumerable;var Gi=(e,t,n)=>t in e?Oo(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,Ki=(e,t)=>{for(var n in t||(t={}))_o.call(t,n)&&Gi(e,n,t[n]);if(qi)for(var n of qi(t))ko.call(t,n)&&Gi(e,n,t[n]);return e};import{B as Lo,C as zi}from"./Container.1c3551f5.js";import{o as Z,i as ut,f as Xi,t as Po,k as vn,l as xo,u as Vo,m as we,q as Mo,r as Wi,g as wn,F as Fo,s as Uo,c as En,p as $o,h as jo,w as Bo}from"./vendor.0543d0c3.js";import{_ as Qi}from"./index.a238f037.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ho{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((t,n)=>{this.resolve=t,this.reject=n})}wrapCallback(t){return(n,i)=>{n?this.reject(n):this.resolve(i),typeof t=="function"&&(this.promise.catch(()=>{}),t.length===1?t(n):t(n,i))}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ee(){return typeof navigator!="undefined"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function qo(){return typeof window!="undefined"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Ee())}function Go(){const e=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof e=="object"&&e.id!==void 0}function Ko(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function zo(){return Ee().indexOf("Electron/")>=0}function Xo(){const e=Ee();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}function Wo(){return Ee().indexOf("MSAppHost/")>=0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qo="FirebaseError";class In extends Error{constructor(t,n,i){super(n);this.code=t,this.customData=i,this.name=Qo,Object.setPrototypeOf(this,In.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Yi.prototype.create)}}class Yi{constructor(t,n,i){this.service=t,this.serviceName=n,this.errors=i}create(t,...n){const i=n[0]||{},s=`${this.service}/${t}`,r=this.errors[t],o=r?Yo(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new In(s,a,i)}}function Yo(e,t){return e.replace(Jo,(n,i)=>{const s=t[i];return s!=null?String(s):`<${i}?>`})}const Jo=/\{\$([^}]+)}/g;function Tn(e,t){if(e===t)return!0;const n=Object.keys(e),i=Object.keys(t);for(const s of n){if(!i.includes(s))return!1;const r=e[s],o=t[s];if(Ji(r)&&Ji(o)){if(!Tn(r,o))return!1}else if(r!==o)return!1}for(const s of i)if(!n.includes(s))return!1;return!0}function Ji(e){return e!==null&&typeof e=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zo{constructor(t,n){this.name=t,this.container=n,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const n=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(n)){const i=new Ho;if(this.instancesDeferred.set(n,i),this.isInitialized(n)||this.shouldAutoInitialize())try{const s=this.getOrInitializeService({instanceIdentifier:n});s&&i.resolve(s)}catch{}}return this.instancesDeferred.get(n).promise}getImmediate(t){var n;const i=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),s=(n=t==null?void 0:t.optional)!==null&&n!==void 0?n:!1;if(this.isInitialized(i)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:i})}catch(r){if(s)return null;throw r}else{if(s)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(ea(t))try{this.getOrInitializeService({instanceIdentifier:ft})}catch{}for(const[n,i]of this.instancesDeferred.entries()){const s=this.normalizeInstanceIdentifier(n);try{const r=this.getOrInitializeService({instanceIdentifier:s});i.resolve(r)}catch{}}}}clearInstance(t=ft){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(n=>"INTERNAL"in n).map(n=>n.INTERNAL.delete()),...t.filter(n=>"_delete"in n).map(n=>n._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=ft){return this.instances.has(t)}getOptions(t=ft){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:n={}}=t,i=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(i))throw Error(`${this.name}(${i}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const s=this.getOrInitializeService({instanceIdentifier:i,options:n});for(const[r,o]of this.instancesDeferred.entries()){const a=this.normalizeInstanceIdentifier(r);i===a&&o.resolve(s)}return s}onInit(t,n){var i;const s=this.normalizeInstanceIdentifier(n),r=(i=this.onInitCallbacks.get(s))!==null&&i!==void 0?i:new Set;r.add(t),this.onInitCallbacks.set(s,r);const o=this.instances.get(s);return o&&t(o,s),()=>{r.delete(t)}}invokeOnInitCallbacks(t,n){const i=this.onInitCallbacks.get(n);if(!!i)for(const s of i)try{s(t,n)}catch{}}getOrInitializeService({instanceIdentifier:t,options:n={}}){let i=this.instances.get(t);if(!i&&this.component&&(i=this.component.instanceFactory(this.container,{instanceIdentifier:ta(t),options:n}),this.instances.set(t,i),this.instancesOptions.set(t,n),this.invokeOnInitCallbacks(i,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,i)}catch{}return i||null}normalizeInstanceIdentifier(t=ft){return this.component?this.component.multipleInstances?t:ft:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function ta(e){return e===ft?void 0:e}function ea(e){return e.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class na{constructor(t){this.name=t,this.providers=new Map}addComponent(t){const n=this.getProvider(t.name);if(n.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);n.setComponent(t)}addOrOverwriteComponent(t){this.getProvider(t.name).isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);const n=new Zo(t,this);return this.providers.set(t,n),n}getProviders(){return Array.from(this.providers.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var S;(function(e){e[e.DEBUG=0]="DEBUG",e[e.VERBOSE=1]="VERBOSE",e[e.INFO=2]="INFO",e[e.WARN=3]="WARN",e[e.ERROR=4]="ERROR",e[e.SILENT=5]="SILENT"})(S||(S={}));const ia={debug:S.DEBUG,verbose:S.VERBOSE,info:S.INFO,warn:S.WARN,error:S.ERROR,silent:S.SILENT},sa=S.INFO,ra={[S.DEBUG]:"log",[S.VERBOSE]:"log",[S.INFO]:"info",[S.WARN]:"warn",[S.ERROR]:"error"},oa=(e,t,...n)=>{if(t<e.logLevel)return;const i=new Date().toISOString(),s=ra[t];if(s)console[s](`[${i}]  ${e.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class Zi{constructor(t){this.name=t,this._logLevel=sa,this._logHandler=oa,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in S))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?ia[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,S.DEBUG,...t),this._logHandler(this,S.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,S.VERBOSE,...t),this._logHandler(this,S.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,S.INFO,...t),this._logHandler(this,S.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,S.WARN,...t),this._logHandler(this,S.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,S.ERROR,...t),this._logHandler(this,S.ERROR,...t)}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aa{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(la(n)){const i=n.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(n=>n).join(" ")}}function la(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const Sn="@firebase/app",ts="0.7.9";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const An=new Zi("@firebase/app"),ca="@firebase/app-compat",ha="@firebase/analytics-compat",ua="@firebase/analytics",fa="@firebase/app-check-compat",da="@firebase/app-check",pa="@firebase/auth",ga="@firebase/auth-compat",ma="@firebase/database",ya="@firebase/database-compat",va="@firebase/functions",wa="@firebase/functions-compat",Ea="@firebase/installations",Ia="@firebase/installations-compat",Ta="@firebase/messaging",Sa="@firebase/messaging-compat",Aa="@firebase/performance",Na="@firebase/performance-compat",ba="@firebase/remote-config",Ca="@firebase/remote-config-compat",Da="@firebase/storage",Ra="@firebase/storage-compat",Oa="@firebase/firestore",_a="@firebase/firestore-compat",ka="firebase",La="9.5.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es="[DEFAULT]",Pa={[Sn]:"fire-core",[ca]:"fire-core-compat",[ua]:"fire-analytics",[ha]:"fire-analytics-compat",[da]:"fire-app-check",[fa]:"fire-app-check-compat",[pa]:"fire-auth",[ga]:"fire-auth-compat",[ma]:"fire-rtdb",[ya]:"fire-rtdb-compat",[va]:"fire-fn",[wa]:"fire-fn-compat",[Ea]:"fire-iid",[Ia]:"fire-iid-compat",[Ta]:"fire-fcm",[Sa]:"fire-fcm-compat",[Aa]:"fire-perf",[Na]:"fire-perf-compat",[ba]:"fire-rc",[Ca]:"fire-rc-compat",[Da]:"fire-gcs",[Ra]:"fire-gcs-compat",[Oa]:"fire-fst",[_a]:"fire-fst-compat","fire-js":"fire-js",[ka]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Te=new Map,Nn=new Map;function xa(e,t){try{e.container.addComponent(t)}catch(n){An.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function bn(e){const t=e.name;if(Nn.has(t))return An.debug(`There were multiple attempts to register component ${t}.`),!1;Nn.set(t,e);for(const n of Te.values())xa(n,e);return!0}function Va(e,t){return e.container.getProvider(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ua=La;function $a(e,t={}){typeof t!="object"&&(t={name:t});const n=Object.assign({name:es,automaticDataCollectionEnabled:!1},t),i=n.name;if(typeof i!="string"||!i)throw Se.create("bad-app-name",{appName:String(i)});const s=Te.get(i);if(s){if(Tn(e,s.options)&&Tn(n,s.config))return s;throw Se.create("duplicate-app",{appName:i})}const r=new na(i);for(const a of Nn.values())r.addComponent(a);const o=new Fa(e,n,r);return Te.set(i,o),o}function ja(e=es){const t=Te.get(e);if(!t)throw Se.create("no-app",{appName:e});return t}function St(e,t,n){var i;let s=(i=Pa[e])!==null&&i!==void 0?i:e;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=t.match(/\s|\//);if(r||o){const a=[`Unable to register library "${s}" with version "${t}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${t}" contains illegal characters (whitespace or "/")`),An.warn(a.join(" "));return}bn(new Ie(`${s}-version`,()=>({library:s,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ql{constructor(t,n){this.user=n,this.type="OAuth",this.authHeaders={},this.authHeaders.Authorization=`Bearer ${t}`}}class Yl{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,n){t.enqueueRetryable(()=>n(q.UNAUTHENTICATED))}shutdown(){}}class Jl{constructor(t){this.t=t,this.currentUser=q.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,n){let i=this.i;const s=l=>this.i!==i?(i=this.i,n(l)):Promise.resolve();let r=new Et;this.o=()=>{this.i++,this.currentUser=this.u(),r.resolve(),r=new Et,t.enqueueRetryable(()=>s(this.currentUser))};const o=()=>{const l=r;t.enqueueRetryable(async()=>{await l.promise,await s(this.currentUser)})},a=l=>{y("FirebaseCredentialsProvider","Auth detected"),this.auth=l,this.auth.addAuthTokenListener(this.o),o()};this.t.onInit(l=>a(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?a(l):(y("FirebaseCredentialsProvider","Auth not yet detected"),r.resolve(),r=new Et)}},0),o()}getToken(){const t=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(i=>this.i!==t?(y("FirebaseCredentialsProvider","getToken aborted due to token change."),this.getToken()):i?(k(typeof i.accessToken=="string"),new Ql(i.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const t=this.auth&&this.auth.getUid();return k(t===null||typeof t=="string"),new q(t)}}class Zl{constructor(t,n,i){this.h=t,this.l=n,this.m=i,this.type="FirstParty",this.user=q.FIRST_PARTY}get authHeaders(){const t={"X-Goog-AuthUser":this.l},n=this.h.auth.getAuthHeaderValueForFirstParty([]);return n&&(t.Authorization=n),this.m&&(t["X-Goog-Iam-Authorization-Token"]=this.m),t}}class tc{constructor(t,n,i){this.h=t,this.l=n,this.m=i}getToken(){return Promise.resolve(new Zl(this.h,this.l,this.m))}start(t,n){t.enqueueRetryable(()=>n(q.FIRST_PARTY))}shutdown(){}invalidateToken(){}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ec(e){const t=typeof self!="undefined"&&(self.crypto||self.msCrypto),n=new Uint8Array(e);if(t&&typeof t.getRandomValues=="function")t.getRandomValues(n);else for(let i=0;i<e;i++)n[i]=Math.floor(256*Math.random());return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Er.T=-1;class Ir{static I(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",n=Math.floor(256/t.length)*t.length;let i="";for(;i.length<20;){const s=ec(40);for(let r=0;r<s.length;++r)i.length<20&&s[r]<n&&(i+=t.charAt(s[r]%t.length))}return i}}function N(e,t){return e<t?-1:e>t?1:0}function Ot(e,t,n){return e.length===t.length&&e.every((i,s)=>n(i,t[s]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class st{constructor(t){this.binaryString=t}static fromBase64String(t){const n=atob(t);return new st(n)}static fromUint8Array(t){const n=function(i){let s="";for(let r=0;r<i.length;++r)s+=String.fromCharCode(i[r]);return s}(t);return new st(n)}toBase64(){return t=this.binaryString,btoa(t);var t}toUint8Array(){return function(t){const n=new Uint8Array(t.length);for(let i=0;i<t.length;i++)n[i]=t.charCodeAt(i);return n}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return N(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}st.EMPTY_BYTE_STRING=new st("");const ic=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function It(e){if(k(!!e),typeof e=="string"){let t=0;const n=ic.exec(e);if(k(!!n),n[1]){let s=n[1];s=(s+"000000000").substr(0,9),t=Number(s)}const i=new Date(e);return{seconds:Math.floor(i.getTime()/1e3),nanos:t}}return{seconds:F(e.seconds),nanos:F(e.nanos)}}function F(e){return typeof e=="number"?e:typeof e=="string"?Number(e):0}function oe(e){return typeof e=="string"?st.fromBase64String(e):st.fromUint8Array(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sc(e){var t,n;return((n=(((t=e==null?void 0:e.mapValue)===null||t===void 0?void 0:t.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function Qe(e){const t=It(e.mapValue.fields.__local_write_time__.timestampValue);return new Q(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ae(e){return e==null}function Ye(e){return e===0&&1/e==-1/0}function rc(e){return typeof e=="number"&&Number.isInteger(e)&&!Ye(e)&&e<=Number.MAX_SAFE_INTEGER&&e>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oc{constructor(t,n=null,i=[],s=[],r=null,o=null,a=null){this.path=t,this.collectionGroup=n,this.orderBy=i,this.filters=s,this.limit=r,this.startAt=o,this.endAt=a,this.A=null}}function br(e,t=null,n=[],i=[],s=null,r=null,o=null){return new oc(e,t,n,i,s,r,o)}function Ai(e){const t=A(e);if(t.A===null){let n=t.path.canonicalString();t.collectionGroup!==null&&(n+="|cg:"+t.collectionGroup),n+="|f:",n+=t.filters.map(i=>lc(i)).join(","),n+="|ob:",n+=t.orderBy.map(i=>function(s){return s.field.canonicalString()+s.dir}(i)).join(","),ae(t.limit)||(n+="|l:",n+=t.limit),t.startAt&&(n+="|lb:",n+=Ze(t.startAt)),t.endAt&&(n+="|ub:",n+=Ze(t.endAt)),t.A=n}return t.A}function ac(e){let t=e.path.canonicalString();return e.collectionGroup!==null&&(t+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(t+=`, filters: [${e.filters.map(n=>{return`${(i=n).field.canonicalString()} ${i.op} ${Ei(i.value)}`;var i}).join(", ")}]`),ae(e.limit)||(t+=", limit: "+e.limit),e.orderBy.length>0&&(t+=`, orderBy: [${e.orderBy.map(n=>function(i){return`${i.field.canonicalString()} (${i.dir})`}(n)).join(", ")}]`),e.startAt&&(t+=", startAt: "+Ze(e.startAt)),e.endAt&&(t+=", endAt: "+Ze(e.endAt)),`Target(${t})`}function Ni(e,t){if(e.limit!==t.limit||e.orderBy.length!==t.orderBy.length)return!1;for(let s=0;s<e.orderBy.length;s++)if(!mc(e.orderBy[s],t.orderBy[s]))return!1;if(e.filters.length!==t.filters.length)return!1;for(let s=0;s<e.filters.length;s++)if(n=e.filters[s],i=t.filters[s],n.op!==i.op||!n.field.isEqual(i.field)||!tt(n.value,i.value))return!1;var n,i;return e.collectionGroup===t.collectionGroup&&!!e.path.isEqual(t.path)&&!!Rr(e.startAt,t.startAt)&&Rr(e.endAt,t.endAt)}class z extends class{}{constructor(t,n,i){super(),this.field=t,this.op=n,this.value=i}static create(t,n,i){return t.isKeyField()?n==="in"||n==="not-in"?this.R(t,n,i):new cc(t,n,i):n==="array-contains"?new fc(t,i):n==="in"?new dc(t,i):n==="not-in"?new pc(t,i):n==="array-contains-any"?new gc(t,i):new z(t,n,i)}static R(t,n,i){return n==="in"?new hc(t,i):new uc(t,i)}matches(t){const n=t.data.field(this.field);return this.op==="!="?n!==null&&this.P(kt(n,this.value)):n!==null&&_t(this.value)===_t(n)&&this.P(kt(n,this.value))}P(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return T()}}v(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}}function lc(e){return e.field.canonicalString()+e.op.toString()+Ei(e.value)}class cc extends z{constructor(t,n,i){super(t,n,i),this.key=I.fromName(i.referenceValue)}matches(t){const n=I.comparator(t.key,this.key);return this.P(n)}}class hc extends z{constructor(t,n){super(t,"in",n),this.keys=Cr("in",n)}matches(t){return this.keys.some(n=>n.isEqual(t.key))}}class uc extends z{constructor(t,n){super(t,"not-in",n),this.keys=Cr("not-in",n)}matches(t){return!this.keys.some(n=>n.isEqual(t.key))}}function Cr(e,t){var n;return(((n=t.arrayValue)===null||n===void 0?void 0:n.values)||[]).map(i=>I.fromName(i.referenceValue))}class fc extends z{constructor(t,n){super(t,"array-contains",n)}matches(t){const n=t.data.field(this.field);return Si(n)&&le(n.arrayValue,this.value)}}class dc extends z{constructor(t,n){super(t,"in",n)}matches(t){const n=t.data.field(this.field);return n!==null&&le(this.value.arrayValue,n)}}class pc extends z{constructor(t,n){super(t,"not-in",n)}matches(t){if(le(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const n=t.data.field(this.field);return n!==null&&!le(this.value.arrayValue,n)}}class gc extends z{constructor(t,n){super(t,"array-contains-any",n)}matches(t){const n=t.data.field(this.field);return!(!Si(n)||!n.arrayValue.values)&&n.arrayValue.values.some(i=>le(this.value.arrayValue,i))}}class bi{constructor(t,n){this.position=t,this.before=n}}function Ze(e){return`${e.before?"b":"a"}:${e.position.map(t=>Ei(t)).join(",")}`}class he{constructor(t,n="asc"){this.field=t,this.dir=n}}function mc(e,t){return e.dir===t.dir&&e.field.isEqual(t.field)}function Dr(e,t,n){let i=0;for(let s=0;s<e.position.length;s++){const r=t[s],o=e.position[s];if(r.field.isKeyField()?i=I.comparator(I.fromName(o.referenceValue),n.key):i=kt(o,n.data.field(r.field)),r.dir==="desc"&&(i*=-1),i!==0)break}return e.before?i<=0:i<0}function Rr(e,t){if(e===null)return t===null;if(t===null||e.before!==t.before||e.position.length!==t.position.length)return!1;for(let n=0;n<e.position.length;n++)if(!tt(e.position[n],t.position[n]))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lr(e,t){if(e.D){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ye(t)?"-0":t}}function Pr(e){return{integerValue:""+e}}function Cc(e,t){return rc(t)?Pr(t):Lr(e,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fc=new J(I.comparator);function Kr(){return Fc}const Uc=new J(I.comparator);function zr(){return Uc}const $c=new J(I.comparator);function jc(){return $c}const Bc=new W(I.comparator);function Tt(...e){let t=Bc;for(const n of e)t=t.add(n);return t}const Hc=new W(N);function qc(){return Hc}class Gc{constructor(t,n){this.databaseId=t,this.D=n}}function Ri(e,t){return e.D?`${new Date(1e3*t.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+t.nanoseconds).slice(-9)}Z`:{seconds:""+t.seconds,nanos:t.nanoseconds}}function Kc(e,t){return e.D?t.toBase64():t.toUint8Array()}function zc(e,t){return Ri(e,t.toTimestamp())}function xt(e){return k(!!e),G.fromTimestamp(function(t){const n=It(t);return new Q(n.seconds,n.nanos)}(e))}function Xr(e,t){return function(n){return new D(["projects",n.projectId,"databases",n.database])}(e).child("documents").child(t).canonicalString()}function Xc(e){const t=D.fromString(e);return k(sh(t)),t}function Oi(e,t){return Xr(e.databaseId,t.path)}function Wc(e){const t=Xc(e);return t.length===4?D.emptyPath():Yc(t)}function Qc(e){return new D(["projects",e.databaseId.projectId,"databases",e.databaseId.database]).canonicalString()}function Yc(e){return k(e.length>4&&e.get(4)==="documents"),e.popFirst(5)}function Wr(e,t,n){return{name:Oi(e,t),fields:n.value.mapValue.fields}}function Jc(e,t){let n;if(t instanceof ln)n={update:Wr(e,t.key,t.value)};else if(t instanceof Pc)n={delete:Oi(e,t.key)};else if(t instanceof Pt)n={update:Wr(e,t.key,t.data),updateMask:ih(t.fieldMask)};else{if(!(t instanceof xc))return T();n={verify:Oi(e,t.key)}}return t.fieldTransforms.length>0&&(n.updateTransforms=t.fieldTransforms.map(i=>function(s,r){const o=r.transform;if(o instanceof sn)return{fieldPath:r.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(o instanceof fe)return{fieldPath:r.field.canonicalString(),appendMissingElements:{values:o.elements}};if(o instanceof de)return{fieldPath:r.field.canonicalString(),removeAllFromArray:{values:o.elements}};if(o instanceof rn)return{fieldPath:r.field.canonicalString(),increment:o.C};throw T()}(0,i))),t.precondition.isNone||(n.currentDocument=function(i,s){return s.updateTime!==void 0?{updateTime:zc(i,s.updateTime)}:s.exists!==void 0?{exists:s.exists}:T()}(e,t.precondition)),n}function Zc(e,t){return e&&e.length>0?(k(t!==void 0),e.map(n=>function(i,s){let r=i.updateTime?xt(i.updateTime):xt(s);return r.isEqual(G.min())&&(r=xt(s)),new _c(r,i.transformResults||[])}(n,t))):[]}function th(e){let t=Wc(e.parent);const n=e.structuredQuery,i=n.from?n.from.length:0;let s=null;if(i>0){k(i===1);const h=n.from[0];h.allDescendants?s=h.collectionId:t=t.child(h.collectionId)}let r=[];n.where&&(r=Qr(n.where));let o=[];n.orderBy&&(o=n.orderBy.map(h=>function(f){return new he(Vt(f.field),function(g){switch(g){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(f.direction))}(h)));let a=null;n.limit&&(a=function(h){let f;return f=typeof h=="object"?h.value:h,ae(f)?null:f}(n.limit));let l=null;n.startAt&&(l=Yr(n.startAt));let c=null;return n.endAt&&(c=Yr(n.endAt)),yc(t,s,o,r,a,"F",l,c)}function Qr(e){return e?e.unaryFilter!==void 0?[nh(e)]:e.fieldFilter!==void 0?[eh(e)]:e.compositeFilter!==void 0?e.compositeFilter.filters.map(t=>Qr(t)).reduce((t,n)=>t.concat(n)):T():[]}function Yr(e){const t=!!e.before,n=e.values||[];return new bi(n,t)}function Vt(e){return K.fromServerFormat(e.fieldPath)}function eh(e){return z.create(Vt(e.fieldFilter.field),function(t){switch(t){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return T()}}(e.fieldFilter.op),e.fieldFilter.value)}function nh(e){switch(e.unaryFilter.op){case"IS_NAN":const t=Vt(e.unaryFilter.field);return z.create(t,"==",{doubleValue:NaN});case"IS_NULL":const n=Vt(e.unaryFilter.field);return z.create(n,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=Vt(e.unaryFilter.field);return z.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const s=Vt(e.unaryFilter.field);return z.create(s,"!=",{nullValue:"NULL_VALUE"});default:return T()}}function ih(e){const t=[];return e.fields.forEach(n=>t.push(n.canonicalString())),{fieldPaths:t}}function sh(e){return e.length>=4&&e.get(0)==="projects"&&e.get(2)==="databases"}const rh="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class oh{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(t){this.onCommittedListeners.push(t)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach(t=>t())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lh{constructor(t){this.Wt=t}}function ch(e){const t=th({parent:e.parent,structuredQuery:e.structuredQuery});return e.limitType==="LAST"?Ac(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jr(e){if(e.code!==u.FAILED_PRECONDITION||e.message!==rh)throw e;y("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ah{constructor(t,n){this.bs={},this.Le=new Er(0),this.Be=!1,this.Be=!0,this.referenceDelegate=t(this),this.ze=new Sh(this),this.Ht=new hh,this.He=function(i,s){return new Ih(i,s)}(this.Ht,i=>this.referenceDelegate.Ps(i)),this.N=new lh(n),this.Je=new wh(this.N)}start(){return Promise.resolve()}shutdown(){return this.Be=!1,Promise.resolve()}get started(){return this.Be}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(){return this.Ht}getMutationQueue(t){let n=this.bs[t.toKey()];return n||(n=new Eh(this.Ht,this.referenceDelegate),this.bs[t.toKey()]=n),n}getTargetCache(){return this.ze}getRemoteDocumentCache(){return this.He}getBundleCache(){return this.Je}runTransaction(t,n,i){y("MemoryPersistence","Starting transaction:",t);const s=new Nh(this.Le.next());return this.referenceDelegate.vs(),i(s).next(r=>this.referenceDelegate.Vs(s).next(()=>r)).toPromise().then(r=>(s.raiseOnCommittedEvent(),r))}Ss(t,n){return p.or(Object.values(this.bs).map(i=>()=>i.containsKey(t,n)))}}class Nh extends oh{constructor(t){super(),this.currentSequenceNumber=t}}class Pi{constructor(t){this.persistence=t,this.Ds=new Li,this.Cs=null}static Ns(t){return new Pi(t)}get xs(){if(this.Cs)return this.Cs;throw T()}addReference(t,n,i){return this.Ds.addReference(i,n),this.xs.delete(i.toString()),p.resolve()}removeReference(t,n,i){return this.Ds.removeReference(i,n),this.xs.add(i.toString()),p.resolve()}markPotentiallyOrphaned(t,n){return this.xs.add(n.toString()),p.resolve()}removeTarget(t,n){this.Ds.cs(n.targetId).forEach(s=>this.xs.add(s.toString()));const i=this.persistence.getTargetCache();return i.getMatchingKeysForTargetId(t,n.targetId).next(s=>{s.forEach(r=>this.xs.add(r.toString()))}).next(()=>i.removeTargetData(t,n))}vs(){this.Cs=new Set}Vs(t){const n=this.persistence.getRemoteDocumentCache().newChangeBuffer();return p.forEach(this.xs,i=>{const s=I.fromPath(i);return this.ks(t,s).next(r=>{r||n.removeEntry(s)})}).next(()=>(this.Cs=null,n.apply(t)))}updateLimboDocument(t,n){return this.ks(t,n).next(i=>{i?this.xs.delete(n.toString()):this.xs.add(n.toString())})}Ps(t){return 0}ks(t,n){return p.or([()=>p.resolve(this.Ds.containsKey(n)),()=>this.persistence.getTargetCache().containsKey(t,n),()=>this.persistence.Ss(t,n)])}}class eo{constructor(){this.activeTargetIds=qc()}Fs(t){this.activeTargetIds=this.activeTargetIds.add(t)}Ms(t){this.activeTargetIds=this.activeTargetIds.delete(t)}Os(){const t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(t)}}class bh{constructor(){this.yi=new eo,this.pi={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(t){}updateMutationState(t,n,i){}addLocalQueryTarget(t){return this.yi.Fs(t),this.pi[t]||"not-current"}updateQueryState(t,n,i){this.pi[t]=n}removeLocalQueryTarget(t){this.yi.Ms(t)}isLocalQueryTarget(t){return this.yi.activeTargetIds.has(t)}clearQueryState(t){delete this.pi[t]}getAllActiveQueryTargets(){return this.yi.activeTargetIds}isActiveQueryTarget(t){return this.yi.activeTargetIds.has(t)}start(){return this.yi=new eo,Promise.resolve()}handleUserChange(t,n,i){}setOnlineState(t){}shutdown(){}writeSequenceNumber(t){}notifyBundleLoaded(){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dh={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery"};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rh{constructor(t){this.vi=t.vi,this.Vi=t.Vi}Si(t){this.Di=t}Ci(t){this.Ni=t}onMessage(t){this.xi=t}close(){this.Vi()}send(t){this.vi(t)}ki(){this.Di()}$i(t){this.Ni(t)}Oi(t){this.xi(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lh extends class{}{constructor(t,n,i){super(),this.credentials=t,this.sr=n,this.N=i,this.kr=!1}$r(){if(this.kr)throw new v(u.FAILED_PRECONDITION,"The client has already been terminated.")}Li(t,n,i){return this.$r(),this.credentials.getToken().then(s=>this.sr.Li(t,n,i,s)).catch(s=>{throw s.name==="FirebaseError"?(s.code===u.UNAUTHENTICATED&&this.credentials.invalidateToken(),s):new v(u.UNKNOWN,s.toString())})}Ki(t,n,i){return this.$r(),this.credentials.getToken().then(s=>this.sr.Ki(t,n,i,s)).catch(s=>{throw s.name==="FirebaseError"?(s.code===u.UNAUTHENTICATED&&this.credentials.invalidateToken(),s):new v(u.UNKNOWN,s.toString())})}terminate(){this.kr=!0}}class Ph{constructor(t,n){this.asyncQueue=t,this.onlineStateHandler=n,this.state="Unknown",this.Or=0,this.Fr=null,this.Mr=!0}Lr(){this.Or===0&&(this.Br("Unknown"),this.Fr=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.Fr=null,this.Ur("Backend didn't respond within 10 seconds."),this.Br("Offline"),Promise.resolve())))}qr(t){this.state==="Online"?this.Br("Unknown"):(this.Or++,this.Or>=1&&(this.Kr(),this.Ur(`Connection failed 1 times. Most recent error: ${t.toString()}`),this.Br("Offline")))}set(t){this.Kr(),this.Or=0,t==="Online"&&(this.Mr=!1),this.Br(t)}Br(t){t!==this.state&&(this.state=t,this.onlineStateHandler(t))}Ur(t){const n=`Could not reach Cloud Firestore backend. ${t}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xh{constructor(t,n,i,s,r){this.localStore=t,this.datastore=n,this.asyncQueue=i,this.remoteSyncer={},this.jr=[],this.Qr=new Map,this.Wr=new Set,this.Gr=[],this.zr=r,this.zr.Ti(o=>{i.enqueueAndForget(async()=>{me(this)&&(y("RemoteStore","Restarting streams for network reachability change."),await async function(a){const l=A(a);l.Wr.add(4),await ge(l),l.Hr.set("Unknown"),l.Wr.delete(4),await fn(l)}(this))})}),this.Hr=new Ph(i,s)}}async function fn(e){if(me(e))for(const t of e.Gr)await t(!0)}async function ge(e){for(const t of e.Gr)await t(!1)}function me(e){return A(e).Wr.size===0}async function so(e,t,n){if(!hn(t))throw t;e.Wr.add(1),await ge(e),e.Hr.set("Offline"),n||(n=()=>yh(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{y("RemoteStore","Retrying IndexedDB access"),await n(),e.Wr.delete(1),await fn(e)})}function ro(e,t){return t().catch(n=>so(e,n,t))}async function dn(e){const t=A(e),n=lt(t);let i=t.jr.length>0?t.jr[t.jr.length-1].batchId:-1;for(;Vh(t);)try{const s=await vh(t.localStore,i);if(s===null){t.jr.length===0&&n.wr();break}i=s.batchId,Mh(t,s)}catch(s){await so(t,s)}oo(t)&&ao(t)}function Vh(e){return me(e)&&e.jr.length<10}function Mh(e,t){e.jr.push(t);const n=lt(e);n.hr()&&n.Vr&&n.Sr(t.mutations)}function oo(e){return me(e)&&!lt(e).ur()&&e.jr.length>0}function ao(e){lt(e).start()}async function Fh(e){lt(e).Nr()}async function Uh(e){const t=lt(e);for(const n of e.jr)t.Sr(n.mutations)}async function $h(e,t,n){const i=e.jr.shift(),s=_i.from(i,t,n);await ro(e,()=>e.remoteSyncer.applySuccessfulWrite(s)),await dn(e)}async function jh(e,t){t&&lt(e).Vr&&await async function(n,i){if(s=i.code,Vc(s)&&s!==u.ABORTED){const r=n.jr.shift();lt(n).dr(),await ro(n,()=>n.remoteSyncer.rejectFailedWrite(r.batchId,i)),await dn(n)}var s}(e,t),oo(e)&&ao(e)}async function Bh(e,t){const n=A(e);t?(n.Wr.delete(2),await fn(n)):t||(n.Wr.add(2),await ge(n),n.Hr.set("Unknown"))}function lt(e){return e.Xr||(e.Xr=function(t,n,i){const s=A(t);return s.$r(),new kh(n,s.sr,s.credentials,s.N,i)}(e.datastore,e.asyncQueue,{Si:Fh.bind(null,e),Ci:jh.bind(null,e),Cr:Uh.bind(null,e),Dr:$h.bind(null,e)}),e.Gr.push(async t=>{t?(e.Xr.dr(),await dn(e)):(await e.Xr.stop(),e.jr.length>0&&(y("RemoteStore",`Stopping write stream with ${e.jr.length} pending writes`),e.jr=[]))})),e.Xr}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vi{constructor(t,n,i,s,r){this.asyncQueue=t,this.timerId=n,this.targetTimeMs=i,this.op=s,this.removalCallback=r,this.deferred=new Et,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch(o=>{})}static createAndSchedule(t,n,i,s,r){const o=Date.now()+i,a=new Vi(t,n,o,s,r);return a.start(i),a}start(t){this.timerHandle=setTimeout(()=>this.handleDelayElapsed(),t)}skipDelay(){return this.handleDelayElapsed()}cancel(t){this.timerHandle!==null&&(this.clearTimeout(),this.deferred.reject(new v(u.CANCELLED,"Operation cancelled"+(t?": "+t:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget(()=>this.timerHandle!==null?(this.clearTimeout(),this.op().then(t=>this.deferred.resolve(t))):Promise.resolve())}clearTimeout(){this.timerHandle!==null&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function lo(e,t){if(wt("AsyncQueue",`${t}: ${e}`),hn(e))return new v(u.UNAVAILABLE,`${t}: ${e}`);throw e}class Hh{constructor(){this.queries=new pe(t=>_r(t),Or),this.onlineState="Unknown",this.so=new Set}}function qh(e){e.so.forEach(t=>{t.next()})}class Gh{constructor(t,n,i,s,r,o){this.localStore=t,this.remoteStore=n,this.eventManager=i,this.sharedClientState=s,this.currentUser=r,this.maxConcurrentLimboResolutions=o,this.$o={},this.Oo=new pe(a=>_r(a),Or),this.Fo=new Map,this.Mo=new Set,this.Lo=new J(I.comparator),this.Bo=new Map,this.Uo=new Li,this.qo={},this.Ko=new Map,this.jo=Mt.ie(),this.onlineState="Unknown",this.Qo=void 0}get isPrimaryClient(){return this.Qo===!0}}async function Kh(e,t,n){const i=Qh(e);try{const s=await function(r,o){const a=A(r),l=Q.now(),c=o.reduce((f,g)=>f.add(g.key),Tt());let h;return a.persistence.runTransaction("Locally write mutations","readwrite",f=>a.Qn.Pn(f,c).next(g=>{h=g;const w=[];for(const b of o){const P=Lc(b,h.get(b.key));P!=null&&w.push(new Pt(b.key,P,Nr(P.value.mapValue),Lt.exists(!0)))}return a.In.addMutationBatch(f,l,w,o)})).then(f=>(f.applyToLocalDocumentSet(h),{batchId:f.batchId,changes:h}))}(i.localStore,t);i.sharedClientState.addPendingMutation(s.batchId),function(r,o,a){let l=r.qo[r.currentUser.toKey()];l||(l=new J(N)),l=l.insert(o,a),r.qo[r.currentUser.toKey()]=l}(i,s.batchId,n),await pn(i,s.changes),await dn(i.remoteStore)}catch(s){const r=lo(s,"Failed to persist write");n.reject(r)}}function co(e,t,n){const i=A(e);if(i.isPrimaryClient&&n===0||!i.isPrimaryClient&&n===1){const s=[];i.Oo.forEach((r,o)=>{const a=o.view.io(t);a.snapshot&&s.push(a.snapshot)}),function(r,o){const a=A(r);a.onlineState=o;let l=!1;a.queries.forEach((c,h)=>{for(const f of h.listeners)f.io(o)&&(l=!0)}),l&&qh(a)}(i.eventManager,t),s.length&&i.$o.Rr(s),i.onlineState=t,i.isPrimaryClient&&i.sharedClientState.setOnlineState(t)}}async function zh(e,t){const n=A(e),i=t.batch.batchId;try{const s=await mh(n.localStore,t);uo(n,i,null),ho(n,i),n.sharedClientState.updateMutationState(i,"acknowledged"),await pn(n,s)}catch(s){await Jr(s)}}async function Xh(e,t,n){const i=A(e);try{const s=await function(r,o){const a=A(r);return a.persistence.runTransaction("Reject batch","readwrite-primary",l=>{let c;return a.In.lookupMutationBatch(l,o).next(h=>(k(h!==null),c=h.keys(),a.In.removeMutationBatch(l,h))).next(()=>a.In.performConsistencyCheck(l)).next(()=>a.Qn.Pn(l,c))})}(i.localStore,t);uo(i,t,n),ho(i,t),i.sharedClientState.updateMutationState(t,"rejected",n),await pn(i,s)}catch(s){await Jr(s)}}function ho(e,t){(e.Ko.get(t)||[]).forEach(n=>{n.resolve()}),e.Ko.delete(t)}function uo(e,t,n){const i=A(e);let s=i.qo[i.currentUser.toKey()];if(s){const r=s.get(t);r&&(n?r.reject(n):r.resolve(),s=s.remove(t)),i.qo[i.currentUser.toKey()]=s}}async function pn(e,t,n){const i=A(e),s=[],r=[],o=[];i.Oo.isEmpty()||(i.Oo.forEach((a,l)=>{o.push(i.Wo(l,t,n).then(c=>{if(c){i.isPrimaryClient&&i.sharedClientState.updateQueryState(l.targetId,c.fromCache?"not-current":"current"),s.push(c);const h=ki.kn(l.targetId,c);r.push(h)}}))}),await Promise.all(o),i.$o.Rr(s),await async function(a,l){const c=A(a);try{await c.persistence.runTransaction("notifyLocalViewChanges","readwrite",h=>p.forEach(l,f=>p.forEach(f.Nn,g=>c.persistence.referenceDelegate.addReference(h,f.targetId,g)).next(()=>p.forEach(f.xn,g=>c.persistence.referenceDelegate.removeReference(h,f.targetId,g)))))}catch(h){if(!hn(h))throw h;y("LocalStore","Failed to update sequence numbers: "+h)}for(const h of l){const f=h.targetId;if(!h.fromCache){const g=c.Un.get(f),w=g.snapshotVersion,b=g.withLastLimboFreeSnapshotVersion(w);c.Un=c.Un.insert(f,b)}}}(i.localStore,r))}async function Wh(e,t){const n=A(e);if(!n.currentUser.isEqual(t)){y("SyncEngine","User change. New user:",t.toKey());const i=await to(n.localStore,t);n.currentUser=t,function(s,r){s.Ko.forEach(o=>{o.forEach(a=>{a.reject(new v(u.CANCELLED,r))})}),s.Ko.clear()}(n,"'waitForPendingWrites' promise is rejected due to a user change."),n.sharedClientState.handleUserChange(t,i.removedBatchIds,i.addedBatchIds),await pn(n,i.Wn)}}function Qh(e){const t=A(e);return t.remoteStore.remoteSyncer.applySuccessfulWrite=zh.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=Xh.bind(null,t),t}class Yh{constructor(){this.synchronizeTabs=!1}async initialize(t){this.N=un(t.databaseInfo.databaseId),this.sharedClientState=this.Ho(t),this.persistence=this.Jo(t),await this.persistence.start(),this.gcScheduler=this.Yo(t),this.localStore=this.Xo(t)}Yo(t){return null}Xo(t){return gh(this.persistence,new dh,t.initialUser,this.N)}Jo(t){return new Ah(Pi.Ns,this.N)}Ho(t){return new bh}async terminate(){this.gcScheduler&&this.gcScheduler.stop(),await this.sharedClientState.shutdown(),await this.persistence.shutdown()}}class Jh{async initialize(t,n){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(n),this.remoteStore=this.createRemoteStore(n),this.eventManager=this.createEventManager(n),this.syncEngine=this.createSyncEngine(n,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=i=>co(this.syncEngine,i,1),this.remoteStore.remoteSyncer.handleCredentialChange=Wh.bind(null,this.syncEngine),await Bh(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return new Hh}createDatastore(t){const n=un(t.databaseInfo.databaseId),i=(s=t.databaseInfo,new Oh(s));var s;return function(r,o,a){return new Lh(r,o,a)}(t.credentials,i,n)}createRemoteStore(t){return n=this.localStore,i=this.datastore,s=t.asyncQueue,r=a=>co(this.syncEngine,a,0),o=no.bt()?new no:new Ch,new xh(n,i,s,r,o);var n,i,s,r,o}createSyncEngine(t,n){return function(i,s,r,o,a,l,c){const h=new Gh(i,s,r,o,a,l);return c&&(h.Qo=!0),h}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,n)}terminate(){return async function(t){const n=A(t);y("RemoteStore","RemoteStore shutting down."),n.Wr.add(5),await ge(n),n.zr.shutdown(),n.Hr.set("Unknown")}(this.remoteStore)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+r.stack),o}(i);throw wt("INTERNAL UNHANDLED ERROR: ",s),i}).then(i=>(this.Ec=!1,i))));return this._c=n,n}enqueueAfterDelay(t,n,i){this.bc(),this.Ac.indexOf(t)>-1&&(n=0);const s=Vi.createAndSchedule(this,t,n,i,r=>this.Vc(r));return this.yc.push(s),s}bc(){this.Tc&&T()}verifyOperationInProgress(){}async Sc(){let t;do t=this._c,await t;while(t!==this._c)}Dc(t){for(const n of this.yc)if(n.timerId===t)return!0;return!1}Cc(t){return this.Sc().then(()=>{this.yc.sort((n,i)=>n.targetTimeMs-i.targetTimeMs);for(const n of this.yc)if(n.skipDelay(),t!=="all"&&n.timerId===t)break;return this.Sc()})}Nc(t){this.Ac.push(t)}Vc(t){const n=this.yc.indexOf(t);this.yc.splice(n,1)}}class vo extends Fi{constructor(t,n){super(t,n),this.type="firestore",this._queue=new hu,this._persistenceKey="name"in t?t.name:"[DEFAULT]"}_terminate(){return this._firestoreClient||wo(this),this._firestoreClient.terminate()}}function uu(e=ja()){return Va(e,"firestore").getImmediate()}function fu(e){return e._firestoreClient||wo(e),e._firestoreClient.verifyNotTerminated(),e._firestoreClient}function wo(e){var t;const n=e._freezeSettings(),i=function(s,r,o,a){return new ru(s,r,o,a.host,a.ssl,a.experimentalForceLongPolling,a.experimentalAutoDetectLongPolling,a.useFetchStreams)}(e._databaseId,((t=e._app)===null||t===void 0?void 0:t.options.appId)||"",e._persistenceKey,n);e._firestoreClient=new Zh(e._credentials,e._queue,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tu(e,t,n){let i;return i=e?n&&(n.merge||n.mergeFields)?e.toFirestore(t,n):e.toFirestore(t):t,i}function Su(e,t){const n=au(e.firestore,vo),i=cu(e),s=Tu(e.converter,t);return Au(n,[yu(mu(e.firestore),"addDoc",i._key,s,e.converter!==null,{}).toMutation(i._key,Lt.exists(!1))]).then(()=>i)}function Au(e,t){return function(n,i){const s=new Et;return n.asyncQueue.enqueueAndForget(async()=>Kh(await su(n),i,s)),s.promise}(fu(e),t)}(function(e,t=!0){(function(n){Rt=n})(Ua),bn(new Ie("firestore",(n,{options:i})=>{const s=n.getProvider("app").getImmediate(),r=new vo(s,new Jl(n.getProvider("auth-internal")));return i=Object.assign({useFetchStreams:t},i),r._setSettings(i),r},"PUBLIC")),St(yr,"3.3.1",e),St(yr,"3.3.1","esm2017")})();var Nu="firebase",bu="9.5.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */St(Nu,bu,"app");const Cu={apiKey:"AIzaSyBoMyY5DqNkMMH2djvJ8yuoY05U7gRntW4",authDomain:"hyr-dev.firebaseapp.com",databaseURL:"https://hyr-dev-default-rtdb.firebaseio.com",projectId:"hyr-dev",storageBucket:"hyr-dev.appspot.com",messagingSenderId:"21615079897",appId:"1:21615079897:web:7e6604d721a54f161669c8",measurementId:"G-S54ZJBTJ47"},Du=$a(Cu),Ru=uu(Du),Ou=async e=>{const t=JSON.parse(JSON.stringify(e)),n=[];for(let i=0;i<t.length;i++)try{const s=await Su(lu(Ru,"players"),{name:t[i].name,score:t[i].score});n.push(Ki({id:s.id},t[i]))}catch(s){console.log(s.code,s.message),n.push("unsaved")}return n};function _u(){const e="0123456789ABCDEF".split("");let t="";for(let n=0;n<6;n++)t+=e[Math.floor(Math.random()*16)];return`#${t}`}const ku=["for","textContent"],Lu=["type","placeholder","disabled","name","id","value"],Pu=["placeholder","disabled","name","id","rows","value"];function xu(e){return(t,n)=>(Z(),ut("div",null,[Xi("label",{for:e.inputName,textContent:Po(e.placeholder)},null,8,ku),e.textArea?vn("",!0):(Z(),ut("input",{key:0,type:e.type,placeholder:e.placeholder,disabled:e.disabled,name:e.inputName,id:e.inputName,value:e.inputValue,onKeyup:n[0]||(n[0]=(...i)=>e.onChange&&e.onChange(...i))},null,40,Lu)),e.textArea?(Z(),ut("textarea",{key:1,placeholder:e.placeholder,disabled:e.disabled,name:e.inputName,id:e.inputName,rows:e.rows,value:e.inputValue,onKeyup:n[1]||(n[1]=(...i)=>e.onChange&&e.onChange(...i))},null,40,Pu)):vn("",!0)]))}const Vu={name:"InputComponent"},Mu=Object.assign(Vu,{props:{type:{type:String,default:"text"},inputValue:{type:[String,Number]},placeholder:{type:String,default:""},disabled:{type:Boolean,default:!1},inputName:{type:String,default:""},textArea:{type:Boolean,default:!1},rows:{type:Number,default:3},onChange:{type:Function}},setup:xu});var Fu=Qi(Mu,[["__scopeId","data-v-64b0b302"]]);const Ft={WAIT:0,LOADING:1,ERROR:2,SUCCESS:3},Uu={name:"RegisterForm",components:{Input:Fu,Button:Lo},setup(){const{dispatch:e}=xo(),{push:t}=Vo(),n=we(2),i=we(!1),s=we([]),r=we(0),o=c=>{const{name:h,value:f}=c.target;if(h==="numPlayers"){if(n.value=0,f==="")n.value=2;else{const w=parseInt(f);n.value=w>4?4:w}return}const g=h.split("").reverse()[0];s.value[g-1]={player:parseInt(g),name:f,score:0,color:_u()}},a=async()=>{if(r.value=Ft.LOADING,s.value.length!==n.value){alert("Please, fill all the players names"),r.value=Ft.ERROR;return}const c=await Ou(s.value);if(c.includes("unsaved")){alert("Error registering players, try again"),r.value=Ft.ERROR;return}s.value=c,r.value=Ft.SUCCESS},l=()=>{i.value=!0};return Mo(()=>{r.value===Ft.SUCCESS&&(e("player/registerUsers",s.value),t({path:"/game"}))}),{LOADING_STATUS:Ft,numPlayers:n,manyPlayers:i,players:s,loading:r,onChange:o,onClickSetManyPlayers:l,registerUsers:a}}},$u=e=>($o("data-v-090c36d5"),e=e(),jo(),e),ju={class:"form"},Bu=$u(()=>Xi("h1",null,"BOWLING 2D",-1)),Hu={key:0,class:"num-players"},qu={key:1};function Gu(e,t,n,i,s,r){const o=Wi("Input"),a=Wi("Button");return Z(),ut("div",ju,[Bu,i.manyPlayers?(Z(),ut("div",qu,[(Z(!0),ut(Fo,null,Uo([...Array(i.numPlayers)],(l,c)=>(Z(),En(o,{key:c,type:"text",placeholder:`Player ${c+1} name`,inputName:`playerName${c+1}`,inputValue:i.players[l]||"",onChange:i.onChange},null,8,["placeholder","inputName","inputValue","onChange"]))),128)),i.players.length===i.numPlayers?(Z(),En(a,{key:0,label:"Start game",action:i.registerUsers,disabled:!1,loading:!1,bg:i.loading===i.LOADING_STATUS.WAIT?"success":i.loading===i.LOADING_STATUS.LOADING||i.loading===i.LOADING_STATUS.SUCCESS?"disabled":"danger"},null,8,["action","bg"])):vn("",!0)])):(Z(),ut("div",Hu,[wn(o,{type:"number",placeholder:"Num players",inputName:"numPlayers",inputValue:i.numPlayers,onChange:i.onChange},null,8,["inputValue","onChange"]),wn(a,{label:"Number of players",action:i.onClickSetManyPlayers,disabled:!1,loading:!1,bg:"success"},null,8,["action"])]))])}var Do=Qi(Uu,[["render",Gu],["__scopeId","data-v-090c36d5"]]);function Ku(e){return(t,n)=>(Z(),En(zi,null,{default:Bo(()=>[wn(Do)]),_:1}))}const zu={name:"RegisterPage",components:{Container:zi,Form:Do},mounted(){this.$store.dispatch("game/clearAllStates"),this.$store.dispatch("player/clearAllStates")}},Ju=Object.assign(zu,{setup:Ku});export{Ju as default};
